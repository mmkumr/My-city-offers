...
class ExpiredLocalads extends StatefulWidget {
  ExpiredLocalads({Key? key}) : super(key: key);

  @override
  _ExpiredLocaladsState createState() => _ExpiredLocaladsState();
}

class _ExpiredLocaladsState extends State<ExpiredLocalads> {
  ...
  getPosts() async {
    final user = Provider.of<UserProvider>(context);
    List data = await user.getPosts("Local Ad");
